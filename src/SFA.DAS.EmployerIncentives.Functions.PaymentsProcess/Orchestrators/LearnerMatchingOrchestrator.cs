...
namespace SFA.DAS.EmployerIncentives.Functions.PaymentsProcess.Orchestrators
{
    public class LearnerMatchingOrchestrator
    {
        ...
        public async Task RunOrchestrator([OrchestrationTrigger] IDurableOrchestrationContext context)
        {
            ...
            var apprenticeshipIncentives = await context.CallActivityAsync<List<ApprenticeshipIncentive>>("GetAllApprenticeshipIncentives", null);
            ...
            foreach (var apprenticeshipIncentive in apprenticeshipIncentives)
            {
                var task = context
                    ...
                    .ContinueWith(x => context.CallActivityAsync("LearnerChangeOfCircumstanceActivity", new LearnerChangeOfCircumstanceInput(apprenticeshipIncentive.Id, apprenticeshipIncentive.ULN)));
