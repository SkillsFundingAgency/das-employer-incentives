...
namespace SFA.DAS.EmployerIncentives.Functions.PaymentsProcess.Activities
{
    public class CalculateDaysInLearning
    {
        ...
        {
            _logger.LogInformation($"Calculating DaysinLearning for apprenticeship incentive id {input.ApprenticeshipIncentiveId}", new { input.ApprenticeshipIncentiveId });
            ...
            _logger.LogInformation($"Calculated DaysinLearning for apprenticeship incentive id {input.ApprenticeshipIncentiveId}", new { input.ApprenticeshipIncentiveId });
        }
    }
}
