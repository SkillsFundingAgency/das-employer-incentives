...
namespace SFA.DAS.EmployerIncentives.Functions.PaymentsProcess.Activities
{
    public class GetAllApprenticeshipIncentives
    {
        ...
        public async Task<List<ApprenticeshipIncentive>> Get([ActivityTrigger]object input)
        {
            ...
            return response.ApprenticeshipIncentives.Select(x=> new ApprenticeshipIncentive { Id = x.Id, ULN = x.ULN }).ToList();
        }
    }
}
