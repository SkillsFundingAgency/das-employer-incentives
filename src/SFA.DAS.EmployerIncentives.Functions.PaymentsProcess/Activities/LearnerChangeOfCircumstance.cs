...
{
    public class LearnerChangeOfCircumstance
    {
        private readonly ICommandDispatcher _commandDispatcher;
        private ILogger<LearnerChangeOfCircumstance> _logger;

        public LearnerChangeOfCircumstance(ICommandDispatcher commandDispatcher, ILogger<LearnerChangeOfCircumstance> logger)
        {
            _commandDispatcher = commandDispatcher;
            _logger = logger;
        }

        [FunctionName("LearnerChangeOfCircumstanceActivity")]
