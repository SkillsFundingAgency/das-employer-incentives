    ...
    public class ValidationOverrideDeleted : IDomainEvent, ILogWriter
    {
        ...
        public Log Log
        {
            get
            {
                ...
                var message = $"Validation override '{ValidationOverrideStep.ValidationType}' with Expiry date '{ValidationOverrideStep.ExpiryDate}' and '{ValidationOverrideId}' deleted for Apprenticeship Incentive with ApprenticeshipIncentiveId {ApprenticeshipIncentiveId} {additionalMessage}";
                return new Log
                {
