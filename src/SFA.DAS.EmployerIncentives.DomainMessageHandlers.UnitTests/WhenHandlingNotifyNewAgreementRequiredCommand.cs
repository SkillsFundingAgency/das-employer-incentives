...
{
    [TestFixture]
    public class WhenHandlingNotifyNewAgreementRequiredCommand
    {
        private HandleNotifyNewAgreementRequiredCommand _sut;
        private Mock<ICommandService> _mockCommandService;
        private Fixture _fixture;
        private NotifyNewAgreementRequiredCommand _command;
        ...
        public void Arrange()
        {
            ...
            _command = _fixture.Create<NotifyNewAgreementRequiredCommand>();
            _sut = new HandleNotifyNewAgreementRequiredCommand(_mockCommandService.Object);
        }
