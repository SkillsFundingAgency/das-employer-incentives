...
namespace SFA.DAS.EmployerIncentives.DomainMessageHandlers.UnitTests
{
    ...
    {
        private HandleEmployerWithdrawalCommand _sut;
        private Mock<ICommandService> _mockCommandService;
        private Fixture _fixture;
        private EmployerWithdrawalCommand _command;
        ...
        public void Arrange()
        {
            ...
            _command = _fixture.Create<EmployerWithdrawalCommand>();
            _sut = new HandleEmployerWithdrawalCommand(_mockCommandService.Object);
        }
