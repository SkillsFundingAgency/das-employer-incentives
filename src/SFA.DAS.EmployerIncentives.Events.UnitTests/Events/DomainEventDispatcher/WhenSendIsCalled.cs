...
namespace SFA.DAS.EmployerIncentives.Events.UnitTests.Events.DomainEventDispatcher
{
    public class WhenSendIsCalled
    {        
        private Services.DomainEventDispatcher _sut;
        ...
        public void Arrange()
        {
            ...
            _sut = new Services.DomainEventDispatcher(_mockServiceProvider.Object);
        }
