...
{
    public class WhenPaymentDeletedHandler
    {
        ...
        [Test]
        public async Task Then_an_archive_record_is_persisted_for_a_payment()
        {
            //Arrange
            var sut = new PaymentDeletedHandler(_mockArchiveDataRepository.Object);
            var @event = _fixture.Create<PaymentDeleted>();
