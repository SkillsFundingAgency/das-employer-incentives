...
namespace SFA.DAS.EmployerIncentives.UnitTests.Shared.AutoFixtureCustomizations
{
    public class IncentiveApplicationCustomization : ICustomization
    {
        public void Customize(IFixture fixture)
        {
            ...
            fixture.Register(() => new IncentiveApplicationFactory().CreateApprenticeship(fixture.Create<Guid>(), fixture.Create<int>(), fixture.Create<string>(), fixture.Create<string>(), 
