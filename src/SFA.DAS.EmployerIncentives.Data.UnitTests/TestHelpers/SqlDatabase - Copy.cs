...
namespace SFA.DAS.EmployerIncentives.Data.UnitTests.TestHelpers
{
    public class SqlDatabase2 : IDisposable
    {
        ...
        private void CreateTestDatabase()
        {
            ...
            var master = @$"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=master;Integrated Security=True";

            using var dbConn = new SqlConnection(master);
        ...
        private void PublishModel()
        {
            ...
            var model = @$"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=model;Integrated Security=True";
            var services = new DacServices(model);
            ...
            policy.Execute(() => services.Deploy(dbPackage, "model", upgradeExisting: true));
        }
