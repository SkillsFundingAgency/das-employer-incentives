...
{
    public class UpdateVrfCaseDetailsForNewApplicationsCommandHandler : ICommandHandler<UpdateVrfCaseDetailsForNewApplicationsCommand>
    {
        private readonly IQueryRepository<IncentiveApplicationLegalEntityDto> _queryRepository;
        private readonly IEventPublisher _eventPublisher;

        public UpdateVrfCaseDetailsForNewApplicationsCommandHandler(IQueryRepository<IncentiveApplicationLegalEntityDto> queryRepository, IEventPublisher eventPublisher)
        {
            _queryRepository = queryRepository;
            _eventPublisher = eventPublisher;
        }
        public async Task Handle(UpdateVrfCaseDetailsForNewApplicationsCommand command, CancellationToken cancellationToken = default)
        {
