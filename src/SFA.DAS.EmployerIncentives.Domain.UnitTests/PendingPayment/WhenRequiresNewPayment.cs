...
namespace SFA.DAS.EmployerIncentives.Domain.UnitTests.ApprenticeshipIncentiveTests
{
    ...
    public class WhenRequiresNewPayment
    {
        ...
        [Test]
        public void Then_is_true_when_due_date_is_on_start_date_of_a_resumed_break_from_learning()
        {
            // arrange            
            ...
            // act
            var result = _sut.RequiresNewPayment(_newPendingPayment, breakInLearnings);
        ...
        [Test]
        public void Then_is_false_when_due_date_is_before_start_date_of_a_stopped_break_from_learning_and_no_other_change()
        {
            // arrange
            var breakInLearnings = new List<BreakInLearning>()
            {
        ...
        [Test]
        public void Then_is_false_when_there_are_no_stopped_break_from_learnings_and_no_other_change()
        {
            // arrange            
            var breakInLearnings = new List<BreakInLearning>();
        ...
        [Test]
        public void Then_is_true_when_due_date_is_before_start_date_of_a_stopped_break_from_learning_and_amount_change()
        {
            // arrange            
            var breakInLearnings = new List<BreakInLearning>()
            {
        ...
        [Test]
        public void Then_is_true_when_there_are_no_stopped_break_from_learnings_and_amount_change()
        {
            // arrange            
            var breakInLearnings = new List<BreakInLearning>();
        ...
        [Test]
        public void Then_is_true_when_due_date_is_before_start_date_of_a_stopped_break_from_learning_and_period_changes()
        {
            // arrange            
            var breakInLearnings = new List<BreakInLearning>()
            {
        ...
        [Test]
        public void Then_is_true_when_there_are_no_stopped_break_from_learnings_and_period_changes()
        {
            // arrange            
            var breakInLearnings = new List<BreakInLearning>();
        ...
        [Test]
        public void Then_is_true_when_due_date_is_before_start_date_of_a_stopped_break_from_learning_and_payment_year_changes()
        {
            // arrange            
            var breakInLearnings = new List<BreakInLearning>()
            {
        ...
        [Test]
        public void Then_is_true_when_there_are_no_stopped_break_from_learnings_and_payment_year_changes()
        {
            // arrange            
            var breakInLearnings = new List<BreakInLearning>();
