...
namespace SFA.DAS.EmployerIncentives.Domain.UnitTests.ApprenticeshipIncentiveTests
{
    public class WhenValidateDaysInLearning
    {
        ...
        public void Arrange()
        {
            ...
            _collectionPeriod = new CollectionPeriod(1, _collectionMonth, _collectionYear, DateTime.Now);
        ...
        public void Then_a_false_validation_result_is_created_when_the_matchedLearner_is_null()
        {
            ...
            _learner.SubmissionData.SetDaysInLearning(90);
        ...
        [Test()]
        public void Then_a_false_validation_result_is_created_when_the_matchedLearner_submissionFound_is_false()
        {
            // arrange            
            var pendingPayment = _sut.PendingPayments.First();
