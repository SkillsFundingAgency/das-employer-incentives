...
Scenario: Withdrawl status set against an apprenticeship in an application
...
Scenario: Withdrawl status set against a ULN with multiple apprenticeships in applications 
...
Scenario: Employer withdrawl removes incentive after an apprenticeship application has been submitted
