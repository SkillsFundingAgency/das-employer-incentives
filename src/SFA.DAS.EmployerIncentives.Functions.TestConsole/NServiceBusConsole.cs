    ...
    public class NServiceBusConsole
    {
        public async Task Run()
        {
            ...
            do
            {
                ...
                var message2 = new CreateIncentiveCommand(1, 2, Guid.NewGuid(), 2, "test", "test", new DateTime(2000, 1, 1), 1, new DateTime(2020, 9, 1), 0, 10001234, DateTime.Now, "joe@bloggs.com", "Course Name", new DateTime(2021, 04, 01));
