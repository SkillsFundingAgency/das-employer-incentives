...
namespace SFA.DAS.EmployerIncentives.Commands.UnitTests.UpdateIncentiveApplication.Validators
{
    public class WhenValidatingUpdateIncentiveApplication
    {
        private UpdateIncentiveApplicationCommandValidator _sut;
        ...
        public void Arrange()
        {
            ...
            _sut = new UpdateIncentiveApplicationCommandValidator();
        }
        ...
        {
            //Arrange
            var command = new UpdateIncentiveApplicationCommand(default, _fixture.Create<long>(), _fixture.Create<IEnumerable<IncentiveApplicationApprenticeship>>());
        ...
        {
            //Arrange
            var command = new UpdateIncentiveApplicationCommand(_fixture.Create<Guid>(), default, _fixture.Create<IEnumerable<IncentiveApplicationApprenticeship>>());
        ...
        {
            //Arrange
            var command = new UpdateIncentiveApplicationCommand(_fixture.Create<Guid>(), _fixture.Create<long>(), new List<IncentiveApplicationApprenticeship>());
        ...
        public async Task Then_the_command_is_invalid_when_the_apprenticeship_apprenticeshipid_has_a_default_value()
        {
            ...
            var command = new UpdateIncentiveApplicationCommand(_fixture.Create<Guid>(), _fixture.Create<long>(), new List<IncentiveApplicationApprenticeship> { apprenticeship });
