...
namespace SFA.DAS.EmployerIncentives.Commands.UnitTests.SendEmail.Handlers
{
    ...
    public class WhenHandlingSendBankDetailsReminderEmailCommand
    {
        ...
        public void Arrange()
        {
            ...
            _sut = new SendBankDetailsReminderEmailCommandHandler(_commandPublisher.Object, _settings.Object);
        }
        ...
        {
            // Arrange
            var command = _fixture.Create<SendBankDetailsReminderEmailCommand>();
            ...
            _commandPublisher.Verify(x => x.Publish(It.Is<SendEmailCommand>(x => x.RecipientsAddress == command.EmailAddress &&
                                                                       x.TemplateId == _templates.BankDetailsReminder.TemplateId &&
