...
{
    public class CreateApprenticeshipIncentiveCommand : DomainCommand, ILockIdentifier, ILogWriter
    {
        public long AccountId { get; }
        public long AccountLegalEntityId { get; }
        public string LockId => $"{nameof(IncentiveApplicationApprenticeshipId)}_{IncentiveApplicationApprenticeshipId}";
        ...
        public CreateApprenticeshipIncentiveCommand(
            long accountId,
            ...
            ApprenticeshipEmployerType apprenticeshipEmployerTypeOnApproval)
        {
            AccountId = accountId;
